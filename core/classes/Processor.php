 ...
 */
class PixlikesProcessorImpl implements PixlikesProcessor {

	/** @var PixlikesMeta plugin configuration */
	protected $meta = null;

	/** @var PixlikesMeta field information */
	...
	protected function configure($config = null) {
		...
		$this->fields = pixlikes::instance('PixlikesMeta', $fields);
	}
	...
	/** @var PixlikesMeta current data; including submitted data */
	protected $data = null;
		...
		try {
			...
			if ($this->form_was_submitted()) {
				...
				if (empty($errors)) {
					...
					$this->data = pixlikes::instance('PixlikesMeta', $input);
	...
	protected function load_data_from_database($option_key) {
		...
		$this->data = pixlikes::instance('PixlikesMeta', $dbconfig);
	}
	...
	protected function validate_input($input) {
		$validator = pixlikes::instance('PixlikesValidator', $this->meta, $this->fields);
