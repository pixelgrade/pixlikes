 ...
 */
class PixlikesFormImpl extends PixlikesHTMLElementImpl implements PixlikesForm {
	...
	protected function configure($config = null) {
		...
		$this->autocomplete = pixlikes::instance('PixlikesMeta', array());

		// setup fields
		$this->fields = pixlikes::instance('PixlikesMeta', $config['fields']);
		unset($config['fields']);
	...
	function field($fieldname, $fieldconfig = null) {
		...
		return pixlikes::instance('PixlikesFormField', $fieldconfig)
			->setmeta('form', $this)
	...
	/** @var PixlikesMeta autocomplete */
	protected $autocomplete = null;

	/**
	 * Autocomplete meta object passed on by the processor.
	 *
	 * @param PixlikesMeta autocomplete values
	 * @return static $this
	 */
	function autocomplete(PixlikesMeta $autocomplete) {
	...
	/**
	 * @param string template path
	 * @param PixlikesMeta configuration
	 * @return string
	 */
	protected function fieldtemplate_render($_template_path, PixlikesMeta $conf) {
