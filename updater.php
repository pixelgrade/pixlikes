...
if ( ! defined( 'ABSPATH' ) || class_exists( 'WPGitHubUpdater' ) || class_exists( 'WP_Pixlikes_GitHub_Updater' ) )
	return;
 ...
 */
class WP_Pixlikes_GitHub_Updater {
...
//		add_action( 'admin_head', array($this, 'ajax_check_update' ));
	...
	public function load_custom_wp_admin_scripts(){
		wp_enqueue_script(  $this->config['slug'] .'_update_check', plugin_dir_url( __FILE__ ) . 'js/update_check.js', array('jquery') );
	}
